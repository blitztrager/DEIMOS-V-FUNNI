...
namespace EverquartzAdventure.Items.Weapons
{
    ...
    public class SundialNimbus : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(7, "她是由性"); // you need to translate these at some point soon // chienese? seriously? - blitz

            Tooltip.SetDefault("A rock, magic power of which is filled with the sun flames and cosmic power.");
            Tooltip.AddTranslation(7, "因为岩石和虫子的所作所为");
        }
        ...
        // here we see the magic that is ExampleMod. i don't code, i steal // thats called coding - blitz
    ...
    public class EverquartzProjectile : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.penetrate = 9999; // world of tanks reference (we paid for terraria so we can make p2w weapons) - blitz
